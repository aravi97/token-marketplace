...
tokens_market.insert({'id': 0, 'name': 'Code Review', 'owner_id': 'alice', 'quantity': 10, 'price': 20})
tokens_market.insert({'id': 1, 'name': 'Dance Tutor', 'owner_id': 'alice', 'quantity': 10, 'price': 20})
tokens_market.insert({'id': 2, 'name': 'Workout partner', 'owner_id':'bob', 'quantity': 10, 'price': 20})
